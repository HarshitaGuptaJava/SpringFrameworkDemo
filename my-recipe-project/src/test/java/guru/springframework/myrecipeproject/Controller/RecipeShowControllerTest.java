...
public class RecipeShowControllerTest {
    ...
    RecipeShowController controller;
    ...
    public void setUp() throws Exception {
        ...
        controller = new RecipeShowController(recipeService);
    ...
    @Test
    public void testGetRecipeNumFormatException() throws Exception {

       // when(recipeService.findById(anyLong())).thenThrow(NotFoundException.class);

        mockMvc.perform(get("/recipe/show/abcs"))
                //  .andExpect(status().isNotFound());
