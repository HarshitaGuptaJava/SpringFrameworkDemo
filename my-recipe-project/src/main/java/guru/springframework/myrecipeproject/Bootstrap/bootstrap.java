package guru.springframework.myrecipeproject.Bootstrap;

import guru.springframework.myrecipeproject.domain.*;
...
public class bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private UnitOfMeaseureRepository unitOfMeaseureRepository;

    public bootstrap(RecipeRepository recipeRepository, CategoryRepository categoryRepository, UnitOfMeaseureRepository unitOfMeaseureRepository) {
        this.recipeRepository = recipeRepository;
        this.categoryRepository = categoryRepository;
        this.unitOfMeaseureRepository = unitOfMeaseureRepository;
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeaseureRepository.findByDescription("Each");

        if (!eachUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeaseureRepository.findByDescription("Tablespoon");

        if (!tableSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeaseureRepository.findByDescription("Teaspoon");

        if (!teaSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOptional = unitOfMeaseureRepository.findByDescription("Dash");

        if (!dashUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptional = unitOfMeaseureRepository.findByDescription("Pint");

        if (!pintUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeaseureRepository.findByDescription("Cup");
        ...
        guacRecipe.setDiffculty(Diffculty.EASY);
      ...
      //  guacNotes.setRecipe(guacRecipe);//commented for bidirectional smart setter setNotes in recipe
...
*/
        ...
        tacosRecipe.setDiffculty(Diffculty.MODERATE);
       ...
       // tacoNotes.setRecipe(tacosRecipe);//commented for bidirectional smart setter setNotes in recipe
